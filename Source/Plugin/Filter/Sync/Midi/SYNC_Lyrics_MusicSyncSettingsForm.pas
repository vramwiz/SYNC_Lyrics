...
type
  ...
  public
    ...
    property AvailableNoteCount: Integer read FAvailableNoteCount;
    property LineSyncStartSeconds: Double read FLineSyncStartSeconds;
...
begin
  ...
  if HitTestFilterLyric(X, Y) >= 0 then
    PianoRollPaintBox.Cursor := crSizeWE
  else
    PianoRollPaintBox.Cursor := crDefault;
end;
