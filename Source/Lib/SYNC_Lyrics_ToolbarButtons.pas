...
begin
  ...
  case FGlyph of
    ...
    tbgLyrics:
      begin
        Canvas.Brush.Style := bsClear;
        Canvas.Rectangle(MidX - 8, MidY - 10,
          MidX + 8, MidY + 10);
        Canvas.MoveTo(MidX - 4, MidY - 5);
        Canvas.LineTo(MidX + 5, MidY - 5);
        Canvas.MoveTo(MidX - 4, MidY);
        Canvas.LineTo(MidX + 5, MidY);
        Canvas.MoveTo(MidX - 4, MidY + 5);
        Canvas.LineTo(MidX + 2, MidY + 5);
      end;
    tbgLinePlacement:
      begin
        Canvas.Brush.Style := bsClear;
